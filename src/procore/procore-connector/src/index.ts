...
const TOKEN_URL = 'https://api.procore.com/oauth/token';
const AUTHORIZATION_URL = 'https://login.procore.com/oauth/authorize';
const REVOCATION_URL = 'https://api.procore.com/oauth/revoke';
const SERVICE_NAME = 'Procore';
